...
export default function ProtectedEmailCampaign({ prefill, onPrefillConsumed }: ProtectedEmailCampaignProps) {
  ...
  if (isAuthenticated) {
    return <EmailCampaign prefill={prefill} onPrefillConsumed={onPrefillConsumed} />;
  }
    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-2xl p-8 border border-orange-100">
          ...
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-2">Email Campaign Manager</h2>
